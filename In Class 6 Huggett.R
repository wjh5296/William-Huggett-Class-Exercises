...
setwd("/Users/billyhuggett/Documents/GitHub/TAD_2021/R lessons/")
...
# The linear and radial accuracy both decreased. However, the change was very slight: 2% for linear and even less for radial. 
