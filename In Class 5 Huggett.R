...
setwd("C:/Users/billyhuggett/Documents/GitHub/TAD_2021/R lessons/")
...
# It reduces the accuracy and recall values:
# Baseline Accuracy:  0.6016898 - 0.5867893 
# Accuracy: 0.937236 - 0.9215805 
# Recall: 0.9358074 - 0.9133899
# Precision: 0.95889 - 0.9510302 
# F1-score: 0.9472081 - 0.9318301
...
# The prior argument controls how prior probabilities are assigned to the training classes.
# The default value is uniform which dictates that the probabilities of observing each class are equal.
...
# This change should make our model better and more accurate. While this change did improve our model, it did so less than I expected, having a minor impact.
